...
public final class PUCLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  boolean showUsers = Boolean.parseBoolean(PentahoSystem.getSystemSetting("login-show-sample-users-hint", "true"));
    ...
    if (!"desktop".equalsIgnoreCase(request.getParameter("mode"))) {
      ...
      out.write("    //Get URL parameters\n");
      out.write("    var requestedURL = '");
      out.print(requestedURL);
      out.write("';\n");
      out.write("    var getParams = requestedURL.split(\"?\");\n");
      out.write("    var params = '';\n");
      out.write("\n");
      out.write("    //If there are no GET parameters on the URL leave the params object empty so that the check for\n");
      out.write("    //a startup report setting is conducted\n");
      out.write("    if (getParams.length > 1) {\n");
      out.write("      params = '?' + getParams[1];\n");
      out.write("    }\n");
      ...
      out.write("    <div id=\"login-logo\"><!-- <img height=\"106\" width=\"164\" src=\"/pentaho/content/common-ui/resources/themes/images/logo_sigh.jpg\" border=\"0\"> --></div>\n");
      out.write("\n");
      ...
      out.write("--> Relat&oacute;rios</h1>\n");
      ...
      out.write("--> Usu&aacute;rio </label>\n");
      ...
      out.write("              <button type=\"submit\" id=\"loginbtn\" class=\"btn-fhemig\">");
