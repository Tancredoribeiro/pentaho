...
<div id="login-wrapper">
  <div id="login-background">
    <div id="login-logo"><!-- <img height="106" width="164" src="/pentaho/content/common-ui/resources/themes/images/logo_sigh.jpg" border="0"> --></div>

    <div id="login-form-container">
      <div id="animate-wrapper">
        <h1><!--<%=Messages.getInstance().getString("UI.PUC.LOGIN.TITLE")%>--> Relat&oacute;rios</h1>
        <form name="login" id="login" action="j_spring_security_check" method="POST" onkeyup="if(window.event && window.event.keyCode && window.event.keyCode==13){var buttonToClick = document.getElementById('loginbtn'); if(buttonToClick){ buttonToClick.click();}}">
          <div class="row-fluid nowrap">
            <div class="input-container">
              <label ><!--<%=Messages.getInstance().getString("UI.PUC.LOGIN.USERNAME")%>--> Usu&aacute;rio </label>
              <input id="j_username" name="j_username" type="text" placeholder="" autocomplete="off">
            </div>
            <div class="input-container">
              <label ><!--<%=Messages.getInstance().getString("UI.PUC.LOGIN.PASSWORD")%> --> Senha</label>
              <input id="j_password" name="j_password" type="password" placeholder="" autocomplete="off">
            </div>
            <div class="input-container">
              <label>&nbsp;</label>
              <button type="submit" id="loginbtn" class="btn-fhemig"><%=Messages.getInstance().getString("UI.PUC.LOGIN.LOGIN")%></button>
