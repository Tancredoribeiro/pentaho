...
pen.define("cdf/lib/CCC/pvc-d1.0", [ "cdf/lib/CCC/def", "cdf/lib/CCC/protovis", "cdf/jquery", "cdf/lib/CCC/tipsy" ], function(def, pv, $) {
    ...
    pvc.round10 = function(value, places) {
        ...
        value = +value;
        if (isNaN(value) || "number" != typeof places || 0 !== places % 1) return 0/0;
    ...
    pvc.BaseChart.add({
        ...
        _getLoadFilter: function() {
            var options = this.options, dataOptions = options.dataOptions, dataWhere = options.dataWhere;
            return void 0 !== dataWhere ? dataWhere : dataOptions && dataOptions.where;
        },
